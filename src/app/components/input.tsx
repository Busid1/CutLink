...
export default function Input() {
    ...
    return (
        <div>
            <form id="formBox" className="max-w-lg mx-auto mt-32 bg-neutral-700 bg-opacity-70 rounded-xl w-9/12 px-7 py-6 shadow-xl" onSubmit={(e) => handleSubmit(e)}>
                        ...
                        {shortURL !== "" ?
                            isLoading ?
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="text-lg text-white font-semibold">Short URL:</span>
                                    <a target="_blank" className="flex justify-center items-center gap-3 text-gray-600 bg-white rounded-lg px-3 py-2 hover:underline font-semibold shadow-lg" href={`${BASE_URL}/${shortURL}`}>
                                        <span ref={shortURLRef}>{BASE_URL}{shortURL}</span>
